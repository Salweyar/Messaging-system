                ...
                availableUser.map((user, key) => {
                  return (
                    user.uid === message.userID ? (
                      <li className="relative flex justify-end items-end inline-block mr-4 py-2 " key={key}>
                        <div className="box-border w-64 py-2 px-6 bg-yellow-50 border border-yellow-200 shadow-md rounded rounded-3xl rounded-br-none">
                          ...
                          {editMode ? (
            <textarea className="w-56 border border-yellow-200 rounded py-1 mt-2" type="text" rows="3" value={editText} onChange={this.onChangeEditText} ></textarea>
          ) : (
                              ...
                              <li className="float-right">
                                <span className="flex mt-6">
                                    ...
                                    <span className="flex">
                                      ...
                                      xmlns="http://www.w3.org/2000/svg"
                                       viewBox="0 0 24 24" fill="black" width="18px" height="18px">
                                         <path d="M0 0h24v24H0z" fill="none"/><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 
                                         21 7l-1.41-1.41z"/>
                                         </svg>
                                         ...
                                         xmlns="http://www.w3.org/2000/svg" 
                                         viewBox="0 0 24 24" fill="black" width="18px" height="18px">
                                           <path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 
                                  ...
                                  {!editMode && (
                                    ...
                                    xmlns="http://www.w3.org/2000/svg" 
                                    viewBox="0 0 24 24" fill="black" width="18px" height="18px">
                                      <path d="M0 0h24v24H0z" fill="none"/><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 
